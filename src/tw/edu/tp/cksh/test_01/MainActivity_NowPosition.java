...
public class MainActivity_NowPosition extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_activity__now_position);
		...
		listener = new Map_Now();
		listener.refnow= this;
    ...
    public void updateMapImage() {
	    	try {
				...
				DownloadAsyncTask_Now task = new DownloadAsyncTask_Now();
				task.refnow = this;
				task.execute(url);
